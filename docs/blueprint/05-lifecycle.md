...
*Each is buildable by the factory itself (dogfooding). The research dogfood (`RESEARCH-lifecycle.md`,
generated by our own research fleet) backs the marketing/whitepaper/positioning specifics with sources.*
